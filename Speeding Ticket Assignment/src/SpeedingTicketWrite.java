...
public class SpeedingTicketWrite {
	 ...
	 */
	public SpeedingTicketWrite(String txtDate, String txtTime, String txtLocation, String txtRegNo, String txtResult, String txtFileName) {
		date = txtDate;
		time = txtTime;
	 ...
	 * @param result The result of the calculation between the speed limit and the vehicle speed
	 */
	 ...
	 */
	public void writingProcess(String letterType) { //The format is optimal when opened with Word.
		try {
